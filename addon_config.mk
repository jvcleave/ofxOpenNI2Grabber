...
common:
    ADDON_CFLAGS = -Ilibs/$(DEPTH_DEVICE)/openni2/include 
    ADDON_LIBS = libs/$(DEPTH_DEVICE)/openni2/libs/libOpenNI2.a 
    ADDON_LIBS += libs/$(DEPTH_DEVICE)/openni2/libs/libXnLib.a
    ADDON_LIBS += libs/$(DEPTH_DEVICE)/openni2/libs/libDepthUtils.a
